...
if DevAbs:get(Davil.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(Davil.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevAbs:get(Davil.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
DavilName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if DavilName then 
DavilNames = DevAbs:smembers(Davil.."Abs:Mute:Names"..msg.chat_id_) or ""
if DavilNames and DavilNames[1] then 
for i=1,#DavilNames do 
if DavilName:match("(.*)("..DavilNames[i]..")(.*)") then 
...
DevAbs:set(Davil.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(Davil.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
